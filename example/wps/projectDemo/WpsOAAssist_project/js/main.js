...
document.write("<script language='javascript' src='otherslib/lib/js-cookies.js?time="+time+"'></script>");
document.write("<script language='javascript' src='otherslib/lib/uuidv1.min.js?time="+time+"'></script>");
//======================wps api常用枚举值=====================

function init() {
  ...
  profilepic.onclick = function () {
    ...
    mobileDark.style.backgroundImage = getColor('to bottom', colors[index].color1, colors[index].color2);
    toTopDark.style.backgroundImage = getColor('to bottom', colors[index].color1, colors[index].color2);
    btnctn.style.backgroundImage = getColor('to top', colors[index].color1, colors[index].color2);
  }
